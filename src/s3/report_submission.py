...
def reportivist_report_submission_handler(event, context):
    ...
    try:
        ...
        resubmission_url = "https://" + REPORTIVIST_MIDDLEWARE_ADDRESS + ":" + REPORTIVIST_MIDDLEWARE_S3_PORT + "/" + REPORT_RESUBMISSION_ENDPOINT
